...
Description: This plugin allows you to display the meta data for a post. Just use the [show_meta] shortcode or add ?show_meta to the end of your page's URL.
Version: 1.0
Author: Kyle Maurer
